    ...
    <section id="about" className="mt-8 min-h-fit flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 lg:px-24 overflow-x-hidden">
      <div className="flex flex-col md:flex-row items-center gap-10">
        <div className="flex-shrink-0 w-full md:w-auto animate-slideInLeft space-y-6">
          <h1 className="text-[28px] sm:text-4xl md:text-5xl lg:text-6xl text-center font-extrabold bg-gradient-to-tr from-red-600 to-red-900 text-transparent bg-clip-text animate-fade-up-fast">
          ...
          <div className="flex w-full flex-col items-center gap-4 sm:flex-row sm:items-start sm:justify-center md:mt-8">
            <div className="bg-red-800 text-white rounded-2xl p-4 sm:p-6 shadow-lg flex flex-col items-center justify-center w-full sm:w-80 min-h-[8rem] sm:min-h-[11.3rem] animate-fade-up-fast" style={{ animationDelay: '50ms' }}>
              <span className="text-4xl sm:text-5xl md:text-6xl font-extrabold">15+</span>
              <span className="mt-1 text-base sm:text-lg md:text-xl font-semibold">Projects Completed</span>
            </div>
            <div className="bg-black text-white text-center rounded-2xl p-4 sm:p-6 shadow-inner flex flex-col items-center justify-center w-full sm:w-80 min-h-[8rem] sm:min-h-[10rem] border-2 border-red-800 animate-fade-up-fast" style={{ animationDelay: '120ms' }}>
              <span className="text-4xl sm:text-5xl md:text-6xl font-extrabold">2+</span>
              <span className="mt-1 text-base sm:text-lg md:text-xl font-semibold">Years — Full-Stack Development</span>
            </div>
            <div className="bg-black text-white text-center rounded-2xl p-4 sm:p-6 shadow-inner flex flex-col items-center justify-center w-full sm:w-80 min-h-[8rem] sm:min-h-[10rem] border-2 border-red-800 animate-fade-up-fast" style={{ animationDelay: '190ms' }}>
              <span className="text-4xl sm:text-5xl md:text-6xl font-extrabold">2+</span>
              <span className="mt-1 text-base sm:text-lg md:text-xl font-semibold">Years — Graphic Design with UI/UX</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="professional-journey" className="mt-8 w-full mx-auto flex flex-col items-center">
        <div className="text-gray-800 dark:text-gray-200 w-full animate-slideInRight">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-center bg-gradient-to-r from-red-500 to-red-700 text-transparent bg-clip-text mb-4 animate-fade-up-fast">
            Who I am
          </h2>

          <p className="leading-relaxed text-center text-lg md:text-xl max-w-4xl mx-auto animate-fade-up-fast">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 animate-fade-up-fast">
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">Intern Software Engineer</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">Computer Science — Eastern University, Sri Lanka</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">Software Engineering (Full-Stack Development) • Graphic Design • UI/UX Design</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">React, Next.js, Node.js, Tailwind CSS, Angular, Python, PHP-Laravel, TypeScript, JavaScript</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">Figma, Adobe Photoshop, Canva, Adobe Illustrator</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">H.K.Bhanuka Shamen Rathnasiri</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">July 20, 2000</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">shamenrathnasiri@gmail.com</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">Polonnaruwa, Sri Lanka</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 sm:p-6 shadow-sm text-center">
              ...
              <p className="text-base sm:text-lg mt-2">FullTime / Freelance</p>
            </div>
          </div>
          ...
          <div className="mt-10 w-full max-w-5xl mx-auto px-2 sm:px-0 animate-fade-up-fast">
            <div className="flex flex-col items-start gap-1 sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl md:text-[28px] font-bold text-gray-900 dark:text-gray-100">Tech Stack Proficiency</h3>
              <span className="text-xs sm:text-sm font-medium uppercase tracking-[0.35em] text-red-600 dark:text-red-400">Live metrics</span>
            </div>
              ...
              {SKILL_PROGRESS.map((skill, index) => {
                ...
                >
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <h4 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-200">{skill.name}</h4>
                    <span className="text-base sm:text-lg font-bold text-red-600 dark:text-red-400">{percentage}%</span>
                  </div>
