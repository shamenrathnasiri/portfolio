    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="mt-3  text-4xl sm:text-7xl md:text-8xl font-bold text-white">
            Hi, I&apos;m Bhanuka Shamen
          </p>

          <p className="mt-2 text-lg sm:text-xl md:text-4xl opacity-90 text-white">
            Software Engineer · UI/UX Designer · Graphic Designer
          </p>
          <p className="text-red-200 text-base sm:text-lg md:text-xl leading-relaxed max-w-5xl">Software Engineer Intern and Computer Science undergraduate at Eastern University, Sri Lanka, passionate about Full-Stack Development and UI/UX Design. Skilled in React, Angular, Express.js, and Figma, I build scalable apps with clean code and creative design.</p>

          <div className="flex gap-4 mt-6">
            <a
              href="#contact"
              className="bg-red-600 text-xl text-white px-4 py-2 rounded-full hover:bg-red-700 transition duration-300 flex items-center justify-center"
            >
              Get in Touch 
            </a>
            <a
              ...
              className="bg-white text-black px-6 py-4 rounded-full hover:bg-gray-200 transition duration-300 flex items-center justify-center"
            >
